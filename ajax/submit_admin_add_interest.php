<?php
    ...
    $url = $web_server.'connect/webservice/setApi.php?rquest=CreateInterest';
    //print_r($_POST);die;
    $fields = array(
        'user_id'                  => $_POST['uid'],
    ...
    //print_r($fields); die;
     ...
     $result = curl_exec($ch);
     //print_r($result);die;
     $result_interest = json_decode($result,true);
     curl_close($ch);
     $status = $result_interest['posts']['status'];
    // if($status==1){
...
?>
        <div class="row">
                ...
                <h3 class="box-title"><a href="javascript:;" onclick="interestForm('<?php echo $_POST['uid']; ?>','<?php echo $_POST['auth_key']; ?>');">Add New Interest</a></h3>
                ...
                ?>
                                <div class="col-lg-4 col-xs-8">
                                    ...
                                    <div class="small-box bg-yellow">
                                        ...
                                        <a href="javascript:;" onclick="editInterestForm('<?php echo $interest_id; ?>','<?php echo $_POST['uid']; ?>','<?php echo $_POST['auth_key']; ?>');" class="small-box-footer">
